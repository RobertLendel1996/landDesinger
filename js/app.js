(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".teachers__slider")) new core(".teachers__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4.5,
        ...
        if (document.querySelector(".bookshop__slider")) new core(".bookshop__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            loop: true,
            navigation: {
                prevEl: ".bookshop__slider .swiper-button-prev"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.2,
        ...
        if (document.querySelector(".clubs__slider")) new core(".clubs__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loop: true,
            navigation: {
                nextEl: ".clubs__slider .swiper-button-next"
            }
        });
        if (document.querySelector(".main-course__slider")) new core(".main-course__slider", {
            ...
            loop: true,
            navigation: {
                nextEl: ".main-course__slider .swiper-button-next"
            }
        });
        if (document.querySelector(".completing__slider")) new core(".completing__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            loop: true,
            navigation: {
                nextEl: ".completing__slider .swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.5,
        ...
        if (document.querySelector(".biography__slider")) new core(".biography__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            spaceBetween: 50,
            ...
            loop: true,
            navigation: {
                nextEl: ".biography__slider .swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".novetly__slider")) new core(".novetly__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
            ...
            loop: true,
            navigation: {
                nextEl: ".novetly__slider .swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".recommendation__slider")) new core(".recommendation__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
            ...
            loop: true,
            navigation: {
                nextEl: ".recommendation__slider .swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".directions__slider")) new core(".directions__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            speed: 800,
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        if (isMobile.any()) {
            ...
            let teachers = document.querySelectorAll(".slide-teachers__image");
            if (teachers.length > 0) for (let index = 0; index < teachers.length; index++) {
                const teacher = teachers[index];
                teacher.addEventListener("click", (function(e) {
                    teacher.parentElement.classList.toggle("_active");
                }));
            }
        } else document.body.classList.add("mouse");
        const search = document.querySelector(".actions-header__item_form");
        document.addEventListener("click", menu);
        function menu(event) {
            if (event.target.closest(".actions-header__icon-search")) search.classList.toggle("_open");
            if (!event.target.closest(".actions-header__item_form")) search.classList.remove("_open");
        }
        const cart = document.querySelector(".header__cart");
        const cartValue = document.querySelector(".header__cart span");
        const speedAnimation = 1e3;
        document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.closest(".slide-products__buy")) {
                const productSlide = targetElement.closest(".products__slide");
                const productImage = productSlide.querySelector(".slide-products__image");
